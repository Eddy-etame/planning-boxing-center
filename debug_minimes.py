...
path = r"c:\Users\Mommy Jayce\Desktop\Boxing Center\Plannings\Minimes projet planning Coachs rentrée 2026.ods"
...
for r, row in enumerate(sheet.findall('table:table-row', ns)):
    if r == 1: # Days row
        ...
        for cell in row.findall('table:table-cell', ns):
            ...
            val = "".join(texts)
            if val:
                print(f"Days Row {r}, col {c}, cs {cs}, repeat {repeat}: '{val}'")
            c += repeat
