/* =====================================================================
   ATTENTION AU GENERATEUR — a lire avant de relancer quoi que ce soit.

   `generate_plannings_db.py` reconstruit ce fichier depuis les ODS du
   dossier sources/. C'est la bonne chaine, et il faut s'en servir.

   MAIS les trois plannings de Portet (portet-provisoire,
   portet-combat, portet-mma) ont ete transcrits depuis des PDF —
   pas des ODS — parce que le patron a fourni des PDF le 11 aout 2026.
   Relancer le generateur SANS avoir depose les ODS correspondants
   dans sources/ les effacerait sans prevenir.

   Le jour ou les ODS de Portet arrivent : on les depose, on relance,
   et on supprime cet avertissement.
   ===================================================================== */
// AUTO-GENERATED by build_db.py — do not edit by hand.
// Source of truth: the official ODS files in ./sources/.

export const DATA_VERSION = "src-ff31ee6b2e13";
  ...
  },
{
  ...
  },
  {
    ...
    day: "vendredi",
    timeSlot: "12h30-13h30",
    activity: "OPEN SPARRING ANGLAISE / KICK",
    coach: "SAMUEL"
  },
  {
    id: "prov-10",
